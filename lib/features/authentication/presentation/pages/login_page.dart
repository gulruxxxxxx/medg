...
import 'package:medg/features/authentication/presentation/pages/sign_up_page.dart';
      ...
      body: GestureDetector(
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              children: [
              Text('Kirish',style: TextStyle(color: AppColors.darkBlue,fontWeight: FontWeight.w700,fontSize: 20),),
                const Gap(44),
                TextFormField(
